                    ...
                    %>
                                <tr id="myUL"  onClick="window.location='AdsDetails.jsp?adsID=<%= allItems[i].getAdsID()%>'">           <%---details on ads------%>                        
                                    ...
                                    <td >
                                        ...
                                        </br></br><p>Category : New items / Used Items </p>
                                    </td>
                                   
                                        <td><p style="font-size:15px; font-weight: bold;"><%= allItems[i].getName()%><input type="hidden" value="<%= allItems[i].getName()%>" name="adsName"/></p></br>
